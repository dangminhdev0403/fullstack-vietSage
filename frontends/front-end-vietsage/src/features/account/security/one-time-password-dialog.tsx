...
export function OneTimePasswordDialog({ temporaryPassword, accountLabel, onClose }: Readonly<Props>) {
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center overflow-y-auto bg-black/45 p-4" role="dialog" aria-modal="true" aria-labelledby="temporary-password-title">
