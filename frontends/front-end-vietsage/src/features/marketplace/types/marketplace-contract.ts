...
export type MarketplaceOrder = { id: string; orderNumber: string; status: string; quantity: number; unitPriceSnapshot?: string | number | null; unitSnapshot?: string | null; totalAmount: string | number; currency: string; serviceNameSnapshot: string; serviceModeSnapshot: "DELIVERY_TO_HOTEL" | "CUSTOMER_AT_SERVICE"; guestNote?: string | null; createdAt: string };
