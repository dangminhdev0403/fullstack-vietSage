...
export type MarketplaceOrder = { id: string; orderNumber: string; status: string; quantity: number; totalAmount: string | number; currency: string; serviceNameSnapshot: string; createdAt: string };
