...
const { getServiceCatalogErrorMessage, getServiceCatalogSyncNotice } = serviceCatalogError;
...
test("reports partial synchronization warnings to the owner", () => {
  assert.deepEqual(
    ...
    }),
    {
      ...
      text: "Đã thêm 2, cập nhật 1, bỏ qua 3 dòng. Bỏ qua dòng 6, 7, 8 vì mã nhóm không tồn tại.",
    },
  );
});
