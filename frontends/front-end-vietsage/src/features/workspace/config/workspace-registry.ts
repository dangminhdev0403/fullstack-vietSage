...
const NAVIGATION: readonly WorkspaceNavigationDefinition[] = [
  ...
  { key: "staff.messages", personas: STAFF_PERSONAS, href: "/hotels/{hotelId}/messages", label: "Tin nhắn phòng", icon: "chat", order: 55, requiresHotel: true, anyCapabilities: ["hotel.requests.view", "hotel.requests.manage"] },
