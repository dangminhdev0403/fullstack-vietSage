...
const NAVIGATION: readonly WorkspaceNavigationDefinition[] = [
  ...
  { key: "owner.hotel.rooms", personas: ["owner"], href: "/owner/hotels/{hotelId}/rooms", label: "Phòng & lưu trú", icon: "bed", order: 110, requiresHotel: true, anyCapabilities: ["hotel.rooms.view", "hotel.rooms.manage", "hotel.rooms.qr.manage", "hotel.stays.view", "hotel.stays.manage", "hotel.reservations.view", "hotel.reservations.manage"] },
  ...
  { key: "staff.requests", personas: STAFF_PERSONAS, href: "/hotels/{hotelId}/requests", label: "Yêu cầu dịch vụ", icon: "assignment", order: 50, requiresHotel: true, anyCapabilities: ["hotel.requests.view", "hotel.requests.manage"] },
