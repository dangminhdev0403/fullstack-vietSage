        ...
        {isLoading && !request ? <div className="animate-pulse space-y-5" aria-label={t("common.wait")}><div className="h-5 w-32 rounded-full bg-[#e2e8e3]" /><div className="h-7 w-2/3 rounded bg-[#e2e8e3]" /><div className="h-16 rounded-xl bg-[#eef3ee]" /></div> : request ? (
          <>
            ...
            <div className="my-6 flex flex-wrap gap-3">
              ...
              <Link href="/g/messages" className="vs-touch-button inline-flex min-h-11 items-center gap-2 rounded-full bg-[#25483f] px-6 text-sm font-semibold text-white transition-colors duration-200 hover:bg-[#1d3932] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#b18b26]"><VsIcon name="support_agent" className="text-xl" />{t("common.contactHotel")}</Link>
            </div>
