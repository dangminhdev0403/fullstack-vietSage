...
export function DataTableEmptyState({
  ...
  return (
    <div role="status" className="px-4 py-12 text-center bg-slate-50/40 sm:px-8">
        <div className="mx-auto max-w-sm space-y-3">
          ...
          <p className="text-sm leading-6 font-medium text-slate-600">{description}</p>
...
export function DataTableErrorState({
  ...
  return (
    <div role="alert" className="px-4 py-12 text-center bg-rose-50/30 sm:px-8">
          ...
          {onRetry ? (
            <div className="pt-2">
              <button
                type="button"
                onClick={onRetry}
                className="min-h-11 px-5 inline-flex items-center gap-2 rounded-xl bg-rose-600 text-sm font-extrabold text-white shadow-xs hover:bg-rose-700 transition cursor-pointer"
              >
                Thử lại
              </button>
            </div>
