...
const BUSINESS_PERMISSION_MENU_PATHS: Record<BusinessPermissionKey, string | null> = {
  ...
  "hotel.marketplace.revenue.view": "/hotels/[hotelId]/marketplace",
  "hotel.revenue-protection.view": "/owner/hotels/[hotelId]/billing",
  "hotel.profile.view": "/owner/hotels/[hotelId]",
  "hotel.profile.manage": "/owner/hotels/[hotelId]",
  ...
  "hotel.rooms.status.manage": "/owner/hotels/[hotelId]/rooms",
  ...
  "hotel.stays.check-in": "/owner/hotels/[hotelId]/stay",
  "hotel.stays.check-out": "/owner/hotels/[hotelId]/stay",
  ...
  "hotel.requests.coordinate": "/owner/hotels/[hotelId]/requests",
  "hotel.requests.execute": "/owner/hotels/[hotelId]/requests",
  ...
  "hotel.billing.checkout": "/owner/hotels/[hotelId]/billing",
