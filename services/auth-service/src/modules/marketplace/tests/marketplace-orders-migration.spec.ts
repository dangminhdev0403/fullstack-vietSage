...
const sql = fs.readFileSync(
  path.resolve(
    __dirname,
    "../../../../prisma/migrations/20260810030000_add_marketplace_orders/migration.sql",
  ),
  "utf8",
);
...
describe("marketplace orders migration", () => {
  it("is additive, idempotency-safe, and capacity/revenue constrained", () => {
    for (const table of ["MarketplaceOrder", "MarketplaceOrderEvent", "MarketplaceRevenueEntry"])
