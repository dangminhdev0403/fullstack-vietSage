    ...
    try {
      ...
      if (orderWithDetails) {
        RequestRealtimeEmitter.emitExternalServiceOrderCreated({
          ...
          partnerSubtotal: orderWithDetails.partnerSubtotal.toString(),
          hotelServiceFeeAmount: orderWithDetails.hotelServiceFeeAmount.toString(),
          customerTotalAmount: orderWithDetails.customerTotalAmount.toString(),
