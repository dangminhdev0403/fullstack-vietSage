...
export const createLocalPartnerBodySchema = z.object({
  ...
  zaloUrl: z.string().trim().max(255).optional(),
  websiteUrl: z.string().trim().max(255).optional(),
  googleMapUrl: z.string().trim().max(500).optional(),
...
export const updateLocalPartnerBodySchema = createLocalPartnerBodySchema.partial();
