...
## Corpus Check
- 1062 files · ~708,473 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8162 nodes · 18788 edges · 394 communities (328 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 336 edges (avg confidence: 0.65)
...
Cohesion: 0.05
Nodes (123): Params, POST(), Params, POST(), GET(), Params, POST(), GET() (+115 more)
...
Cohesion: 0.19
Nodes (15): Context, DELETE(), GET(), headers, POST(), Context, headers, POST() (+7 more)
...
Cohesion: 0.05
Nodes (21): HOTEL_ASSIGNMENT_REQUIRED_ROLE_CODES, HOTEL_OPERATOR_ROLE_CODES, HotelAccessService, HotelActorContext, Injectable, HotelStaffAssignmentsService, Injectable, HotelsService (+13 more)

### Community 7 - "unwrapApiEnvelope"
Cohesion: 0.05
Nodes (37): ownerRoomsRepository, StaffRoomsListInput, staffRoomsRepository, ownerRoomsResource, staffRoomsResource, AuthRequestOptions, createHotelOpsService(), HotelOpsService (+29 more)
...
Cohesion: 0.10
Nodes (22): distanceLabel(), GuestLocalPartners(), GuestNearbyPreview(), HotelPartnerSettlementsTab(), PartnerDetailModal(), safeExternalUrl(), PartnerFormModal(), PartnerFormModalProps (+14 more)
...
Cohesion: 0.06
Nodes (30): addHours(), generateOpaqueToken(), HotelRoomsService, MANUAL_ROOM_STATUSES, Injectable, ReservationsService, Injectable, AssignReservationRoomBodyInput (+22 more)
...
Cohesion: 0.09
Nodes (48): getExternalOrderStatusBadge(), GuestRequestsPage(), RequestSourceTab, GuestReveal(), GuestCurrentRequest(), Props, GuestRequestCard(), Props (+40 more)
...
Cohesion: 0.07
Nodes (46): GET(), AuthRefreshGate(), AuthRefreshGateProps, loginUrl(), logoutToLogin(), HotelsLayout(), redirectToLogin(), assertCanAccessOwner() (+38 more)

### Community 36 - "import.types.ts"
Cohesion: 0.09
Nodes (17): ImportModule, Module, ImportRegistry, Injectable, ImportService, Injectable, ImportAction, ImportAdapter (+9 more)
...
Cohesion: 0.08
Nodes (26): LoggingModule, Global, Module, InvoiceController, ApiTags, Controller, BillingModule, Module (+18 more)
...
Cohesion: 0.13
Nodes (6): ServiceItemImportService, Injectable, FORBIDDEN_CATEGORY_HEADERS, MarketplaceServiceItemImportAdapter, REQUIRED_HEADERS, Injectable
...
Cohesion: 0.08
Nodes (41): FormState, locationFromHotel(), OwnerHotelDetailClient(), OwnerHotelDetailClientProps, ServiceCatalogPage(), ServiceDashboardPage(), ServiceOrdersPage(), ServiceSettingsPage() (+33 more)
...
Cohesion: 0.07
Nodes (28): GET(), normalizeDayFilter(), Params, positiveInt(), Params, Params, sanitizeUpdateRoomPayload(), Params (+20 more)
...
Cohesion: 0.08
Nodes (29): AdminBillingClient(), Contract, HotelOption, Period, Summary, metadata, BillableDayItem, OwnerAnalyticsData (+21 more)

### Community 63 - "MarketplaceAdminService"
Cohesion: 0.16
Nodes (4): MarketplaceAdminService, Injectable, MarketplaceCategoryBody, ServiceTenantUpdateBody
...
Cohesion: 0.08
Nodes (16): AccessTokenPayload, AuthTokensResponse, LegacyRefreshTokenPayload, PasswordVerificationResult, HotelUserDirectoryEntry, HotelUserDirectoryService, Injectable, IdentityModule (+8 more)
...
Cohesion: 0.09
Nodes (34): AdminShell(), AdminShellProps, AdminRolesPage(), isRecord(), mapRole(), moduleFromPath(), normalizeSidebarItems(), RolePermissionView (+26 more)
...
Cohesion: 0.13
Nodes (15): calculateHaversineDistanceMeters(), hotelLinksQuerySchema, HotelServiceLinkBody, hotelServiceLinkBodySchema, httpUrl, id, location, marketplaceCategoryBodySchema (+7 more)
...
Cohesion: 0.08
Nodes (55): VsServiceImagePreview(), VsServiceImagePreviewProps, CartFlowStep, GuestMarketplaceCartFlow(), GuestMarketplaceCartFlowProps, distance(), getGuestOrderStatusBadge(), GuestMarketplace() (+47 more)
...
Cohesion: 0.06
Nodes (72): Context, DELETE(), Context, GET(), AdminHotelsPage(), listTenantOwnersForSelector(), AdminUsersPage(), first() (+64 more)

### Community 102 - "AppLogger"
Cohesion: 0.06
Nodes (19): AppLogger, LogDomain, LogLevel, LogMetadata, Injectable, redactLogMetadata(), redactValue(), RequestContext (+11 more)
...
Cohesion: 0.12
Nodes (19): PageProps, BiometricOwnerTabs(), CccdCheckInCapture, CccdCheckInPanel(), Props, CccdPreview(), Props, CheckInWorkspace() (+11 more)
...
Cohesion: 0.09
Nodes (37): navItems, NavKey, VsBottomNav(), VsBottomNavProps, VsTopBar(), GuestHomePage(), normalizeVietnameseText(), Context (+29 more)
...
Cohesion: 0.06
Nodes (46): config, POST(), serverErrorResponse(), tokenTail(), unauthorizedResponse(), buildLoginRedirect(), GET(), getCallbackUrl() (+38 more)
...
Cohesion: 0.07
Nodes (18): MarketplaceOrderService, Injectable, batchSettleSchema, CheckoutCart, checkoutCartSchema, CreateMarketplaceOrder, createMarketplaceOrderSchema, marketplaceRevenueQuerySchema (+10 more)
...
Cohesion: 0.15
Nodes (12): GuestEmergencyContext, GuestEmergencyContextService, Injectable, GuestRequestListItemResponse, GuestRequestResponse, GuestPortalRequestPriority, GuestPortalRequestStatus, ListGuestCategoryServicesQueryInput (+4 more)
...
Cohesion: 0.09
Nodes (36): AdminDashboardPage(), DashboardPageProps, AdminLayout(), redirectToLogin(), OwnerHotelsPage(), redirectToLogin(), ServiceLayout(), StaffEntryPage() (+28 more)
...
Cohesion: 0.09
Nodes (34): actionMeta, compareValues(), defaultLabels, escapeHtml(), formatDayFilterValue(), formatRequestMoney(), getExternalOrderStatusLabel(), getHttpErrorMessage() (+26 more)
...
Cohesion: 0.08
Nodes (25): confirmOwnerSave(), createOwnerSchema, editOwnerSchema, emptyForm, formatDate(), formatTenantDisplayName(), FormMode, OwnerFormState (+17 more)
...
Cohesion: 0.06
Nodes (13): hashOpaqueToken(), GuestOsService, Inject, Injectable, Optional, CreateGuestRequestBodyInput, GuestPortalRequestStatusFilter, ListGuestRequestsQueryInput (+5 more)
...
Cohesion: 0.10
Nodes (27): RequestWithUser, PaymentController, RequestWithUser, ApiBody, ApiHeader, ApiOkResponse, ApiParam, ApiTags (+19 more)
...
Cohesion: 0.12
Nodes (13): ImportCommitInput, ImportCommitResult, Payload, PrismaMarketplaceService, Row, State, StateItem, ParsedServiceCatalogCategory (+5 more)
...
Cohesion: 0.13
Nodes (25): resolveBusinessPermissionMenuPath(), GLOBAL_MENU_ORDER, HIDDEN_NAVIGATION_MENU_PATHS, MENU_PATH_ALIASES, compareModuleKeysByNavigationOrder(), humanizeModuleName(), isHiddenModuleKey(), isHiddenNavigationPath() (+17 more)
...
Cohesion: 0.15
Nodes (7): GuestLocalPartnersService, Injectable, LocalPartnersRepository, partnerInclude, Injectable, LocalPartnersModule, Module
...
Cohesion: 0.02
Nodes (154): assignHotelUserRolesBodySchema, authLogoutDataSchema, authMeDataSchema, authTokensDataSchema, createHotelBodySchema, createHotelUserBodySchema, createRoleBodySchema, createServiceItemBodySchema (+146 more)
...
Cohesion: 0.09
Nodes (21): PUBLIC_PATTERNS, PUBLIC_REGEX, publicMatcher, AuthorizationService, PermissionCheckResult, Injectable, buildRoutePermissionKey(), isPermissionPathTooLong() (+13 more)
...
### Community 396 - "MarketplaceCategorySheetService"
Cohesion: 0.32
...
## Knowledge Gaps
- **2453 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+2448 more)
...
- **Why does `PrismaService` connect `.assertHotelAccess` to `HotelAccessService`, `guest-os.service.ts`, `hotel-services.controller.ts`, `prisma.service.ts`, `HttpError`, `service-portal.controller.ts`, `hotel-rooms.service.ts`, `RbacService`, `RequestRealtimeTicketService`, `HotelRoomsRepository`, `GuestRequestEventPublisher`, `service-catalog-import.adapter.ts`, `biometric-workstations.controller.ts`, `TenantOwnersService`, `import.types.ts`, `guest-marketplace.controller.ts`, `property.module.ts`, `LocalPartnersRepository`, `MarketplaceServiceItemImportAdapter`, `marketplace-category-import.adapter.ts`, `GuestOsService`, `MarketplaceAdminService`, `GuestMessagesService`, `EmergencyRepository`, `identity.module.ts`, `._make_store`, `HotelRequestsRepository`, `HotelUsersRepository`, `AppLogger`, `platform-billing.service.ts`, `hotel-requests.service.ts`, `guest-os.repository.ts`, `i18n.service.ts`, `hotel-dashboard.service.ts`, `MarketplaceOrderService`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `ApiDescript()` connect `parseWithZod` to `PrismaService`, `.getInvoiceDetail`, `.getDashboard`, `auth.controller.ts`, `RequestRealtimeTicketService`, `ApiDescript`, `.processWebhook`, `GuestRequestEventPublisher`, `biometric-workstations.controller.ts`, `PlatformBillingController`, `HotelUsersController`, `hotel-requests.controller.ts`, `marketplace/route.ts`, `.listHotels`, `contract-schemas.ts`, `platform-billing.controller.ts`, `FolioController`, `.resetPassword`, `SuccessMessage`, `HotelServicesController`, `.assignRoom`, `HotelRequestsController`, `guest-os.controller.ts`, `health.controller.ts`, `.list`, `HotelRoomsController`, `.create`?**
...
- **Should `executeHotelOpsBackendRequest` be split into smaller, more focused modules?**
  _Cohesion score 0.050507185122569735 - nodes in this community are weakly interconnected._