# Codex Instructions for fullstack-vietSage

Codex must follow `AGENTS.md` before making changes in this repository.

Minimum required flow:

1. Read `AGENTS.md`.
2. Read the nearest relevant `ARCHITECTURE.md` and `RULES.md`.
